...
public class FertilizerDAOImpl implements FertilizerDAO {
    @Override
    public ArrayList<Fertilizer> getAll() throws SQLException, ClassNotFoundException {
    ...
    @Override
    public boolean save(Fertilizer entity) throws SQLException, ClassNotFoundException {
    ...
    @Override
    public boolean update(Fertilizer entity) throws SQLException, ClassNotFoundException {
    ...
    @Override
    public Fertilizer search(String id) throws SQLException, ClassNotFoundException {
    ...
    @Override
    public boolean updateFertilizer(List<FertilizerSalesCartTm> tmList) throws SQLException, ClassNotFoundException {
    ...
    @Override
    public boolean updateQty(FertilizerSalesCartTm cartTm) throws SQLException, ClassNotFoundException {

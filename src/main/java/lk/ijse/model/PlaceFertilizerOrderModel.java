...
public class PlaceFertilizerOrderModel {
    ...
    public boolean placeFertilizerOrder(PlaceFertilizerOrderDto dto) throws SQLException {
        ...
        try{
            ...
            boolean isOrderSaved = fertilizerOrderModel.saveFertilizerOrder(dto);

            if(isOrderSaved) {
                boolean isUpdated = fertilizerModel.updateFertilizer(dto.getTmList());

                if (isUpdated){
                    boolean isFertilizerOrderDetailSaved = fertilizerOrderDetailModel.saveFertilizerOrderDetail(dto.getFertilizerOrderId(),dto.getTmList());
